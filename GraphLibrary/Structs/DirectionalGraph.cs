...
public struct DirectionalGraph<T> : IGraph<T>, IEquatable<DirectionalGraph<T>> where T : IEquatable<T>
{
    ...
    public void ConnectGraph(DirectionalGraph<T> graph, T vertex1, T vertex2)
    {
    ...
    public int GetIncidentEdgeCount(T vertex)
    {
    ...
    {
        return Edges.Where(e => e.Vertex1.Equals(vertex));
    }
